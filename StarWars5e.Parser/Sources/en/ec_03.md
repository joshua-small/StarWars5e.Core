...
![gHG5amO](https://www.gmbinder.com/images/gHG5amO.png)
...
You can use an action to give yourself the benefits of the _true sight_ force power for 1 hour. Once you use this feature, you must finish a short or long rest before you can use it again.
...
_**Armored Approach:** 14th level_
...
![Thibbledorf_Pwent-removebg-preview](https://cdn.discordapp.com/attachments/469499280994992128/907999093081653258/Thibbledorf_Pwent-removebg-preview.png)
...
![YqU2kRu](https://www.gmbinder.com/images/YqU2kRu.png)
...
![Bantha_Rider_BRVP-removebg-preview](https://cdn.discordapp.com/attachments/469499280994992128/932073076378714112/Bantha_Rider_BRVP-removebg-preview.png)
...
![ZG0fURq](https://www.gmbinder.com/images/ZG0fURq.png)
...
![EJ7lAHo](https://www.gmbinder.com/images/EJ7lAHo.png)
...
![nHytg2E](https://www.gmbinder.com/images/nHytg2E.png)
...
![zfue4ei](https://www.gmbinder.com/images/zfue4ei.png)
...
![ilyi6Mj](https://www.gmbinder.com/images/ilyi6Mj.png)
...
_**Industrial Approach:** 14th level_
...
![nOm7Msc](https://www.gmbinder.com/images/nOm7Msc.png)
...
_**Precision Approach:** 14th level_
...
![WTnjBcN](https://www.gmbinder.com/images/WTnjBcN.png)
...
![Fztc5iP](https://www.gmbinder.com/images/Fztc5iP.png)
...
_**Way of Confluence:** 6th level_
...
_**Way of Confluence:** 18th level_
...
![4ttaft8](https://www.gmbinder.com/images/4ttaft8.png)
...
_**Way of Endurance:** 18th level_
...
![HNr2yz4](https://www.gmbinder.com/images/HNr2yz4.png)
...
![z2Z0HPg](https://www.gmbinder.com/images/z2Z0HPg.png)
...
You can store a maximum number of power surges equal to your Wisdom or Charisma modifier (your choice, minimum of one). Whenever you successfully end a force power with a power such as _force suppression_ or _sever force_, or use your Force Shield or Force Deflection features to successfully avoid an attack or succeed on a saving throw, you gain one power surge, as you redirect the flow of the Force into yourself.
...
![pq3knax](https://www.gmbinder.com/images/pq3knax.png)
...
As an action, choose one creature that you can see within 60 feet of you. That creature must make a Wisdom saving throw against your universal force save DC. If the creature succeeds on the saving throw, you can't use this feature on it again until you finish a long rest. If the creature fails its save, you can read its surface thoughts (those foremost in its mind, reflecting its current emotions and what it is actively thinking about) when it is within 60 feet of you. This effect lasts for 1 minute. During that time, you can use your action to end this effect and cast the _coerce mind_ force power at its base level on the creature without expending force points. The target automatically fails its saving throw against the power.
...
![gqzswlS](https://www.gmbinder.com/images/gqzswlS.png)
...
![WrotCbm](https://www.gmbinder.com/images/WrotCbm.png)
...
![sFrtG1P](https://www.gmbinder.com/images/sFrtG1P.png)
...
![3O1yfjY](https://www.gmbinder.com/images/3O1yfjY.png)
...
![pAVqGQM](https://www.gmbinder.com/images/pAVqGQM.png)
...
_**Prerequisite:** 15th level, Hardening_
You have resistance to ion damage.

##### Advanced Grounding System

_**Prerequisite:** 15th level, Prototype Grounding System_
You have resistance to lightning damage.

##### Advanced Jamming Phased Array

_**Prerequisite:** 15th level, Prototype Jamming Phased Array_
...
_**Prerequisite:** 15th level, Prototype Pulsating Phased Array_
...
_**Prerequisite:** 15th level, Prototype Targeting Phased Array_
...
You can cast the _override interface_ tech power at 5th level without spending tech points.
...
_**Prerequisite:** 7th level, Grounding System_
You have immunity to the shocked condition.

##### Prototype Jamming Phased Array

_**Prerequisite:** 7th level, Jamming Phased Array_
While your jamming field is active, when a creature within your field attempts to cast a tech power, you can use your reaction to cast the _tech override_ power at 3rd level without spending tech points. When you cast this power using this feature and you make the techcasting ability check as a part of this casting, you add your proficiency bonus to the check.

Once you've used this feature, you must complete a short or long rest before you can use it again.

##### Prototype Ionizing Phased Array

_**Prerequisite:** 7th level, Ionizing Phased Array_
...
_**Prerequisite:** 7th level, Target Marking Phased Array_
While your targeting field is active, as an action, you can cast the _scramble interface_ power at 3rd level without spending tech points.
...
_**Prerequisite:** 11th level, Flashlight Attachment_
...
- Your droid is a valid target of the _tracker droid interface_ tech power.
...
![QLbAs0t](https://www.gmbinder.com/images/QLbAs0t.png)
...
![GOXClxY](https://www.gmbinder.com/images/GOXClxY.png)
...
While playing your Song of Disruption, when a creature you can see that can hear you attempts to cast a power, you can use your reaction to cast the _tech override_ power at 3rd level. When you cast this power using this feature, the power works against both tech and force powers, and when you make the techcasting ability check as a part of this casting, you your proficiency bonus to the check.
...
![oTDSfb9](https://www.gmbinder.com/images/oTDSfb9.png)
...
You upgrade your distributor, interfacing it with the target of your _tracker droid interface_ power. When you use your action to activate your distributor, while your tracker droid is within 100 feet of you, you can choose to have your tracker droid deliver the mixture. Your tracker droid must use its reaction to deliver the mixture.
...
As an action, you can cast the _oil slick_ tech power without expending tech points. Casting the power in this way does not require concentration, and the oil will remain in place for the full duration of the power.
...
_**Prerequisite:** 11th level, Luminous Gel_
...
![Je8QEgo](https://www.gmbinder.com/images/Je8QEgo.png)
...
_**Construction Engineering:** 3rd, 11th, and 17th level_
...
- You can restore missing hit points to your structure by casting the _mending_ tech power on it, or by completing a short or long rest. Casting the _mending_ tech power restores a number of missing hit points equal to your Intelligence modifier (minimum of one), but it can't be repaired to more than half its hit point maximum in this way. Completing a short rest restores your structure to half its hit point maximum, and completing a long rest restores it to its hit point maximum.
...
_**Construction Engineering:** 18th level_
...
![rMiCs3H](https://www.gmbinder.com/images/rMiCs3H.png)
...
_**Prerequisite:** 15th level, Prototype Biotic Amplifier_
...
_**Prerequisite:** 15th level, Prototype Corrosive Amplifier_
...
_**Prerequisite:** 15th level, Prototype Cryo Amplifier_
...
_**Prerequisite:** 15th level, Prototype Explosive Amplifier_
...
_**Prerequisite:** 7th level, Biotic Amplifier_
...
_**Prerequisite:** 7th level, Corrosive Amplifier_
...
_**Prerequisite:** 7th level, Cryo Amplifier_
...
_**Prerequisite:** 7th level, Explosive Amplifier_
...
You can cast the _burst of speed_ force power targeting yourself at 1st-level without expending force points. At 10th level, when you do so, your speed increases by an additional 10 feet. At 18th level, when you do so, your speed increases by an additional 10 feet.
...
![RUmDcAB](https://www.gmbinder.com/images/RUmDcAB.png)
...
You learn to completely ignore many of the most devastating impediments of combat. You can expend a use of Indomitable to gain the effect of the _freedom of movement_ force power until the end of your next turn.
...
![O85GUMO](https://www.gmbinder.com/images/O85GUMO.png)
...
![jH8d8Mh](https://www.gmbinder.com/images/jH8d8Mh.png)
...
You learn specialized theory typical for practitioners of the enhancement trade. You gain proficiency in your choice of the Lore or Technology skills. Additionally, you learn your choice of the _encrypted message_ or _minor hologram_ tech power. Intelligence is your techcasting ability for these powers.
...
![fVeQ6uW](https://www.gmbinder.com/images/fVeQ6uW.png)
...
![TPUYOZz](https://www.gmbinder.com/images/TPUYOZz.png)
...
_**Fireteam Specialist:** 18th level_
...
![0MwwE14](https://www.gmbinder.com/images/0MwwE14.png)
...
![MlrB546](https://www.gmbinder.com/images/MlrB546.png)
...
![wItcKn0](https://www.gmbinder.com/images/wItcKn0.png)
...
![qCmCdNi](https://www.gmbinder.com/images/qCmCdNi.png)
...
![MuHNLvq](https://www.gmbinder.com/images/MuHNLvq.png)
...
- Your companion is a valid target of the _tracker droid interface_ tech power.
...
_**Ataru Form:** 3rd level_
As a bonus action, you can take an aggressive stance, leaping around the battlefield for 1 minute. As a part of this bonus action, and as a bonus action on each of your turns, you can cast the _force jump_ power at 1st-level without expending force points. Additionally, when you cast _force jump_, you have advantage on the first attack roll you make against each creature within 5 feet of where you land.
...
![BWuZ77A](https://www.gmbinder.com/images/BWuZ77A.png)
...
![AWxckDM](https://www.gmbinder.com/images/AWxckDM.png)
...
When you reduce the damage dealt by a force power to 0 using the _saber reflect_ power, and you're wielding a lightweapon or vibroweapon, you can expend a use of your Channel the Force to reflect the attack at a target within range, regardless of what type the damage is.

![XSgalq5](https://www.gmbinder.com/images/XSgalq5.png)
...
![B55mV5X](https://www.gmbinder.com/images/B55mV5X.png)
...
![LKsiRge](https://www.gmbinder.com/images/LKsiRge.png)
...
![dF0zRmv](https://www.gmbinder.com/images/dF0zRmv.png)
...
![qOrHbRd](https://www.gmbinder.com/images/qOrHbRd.png)
...
![knightofzakuul2](https://cdn.discordapp.com/attachments/555380018310676492/784117609570238514/knightofzakuul2.png)
...
![knightofzakuul3](https://media.discordapp.net/attachments/555380018310676492/784433700690591744/knightofzakuul3.png)
...
![YeXkOtP](https://www.gmbinder.com/images/YeXkOtP.png)
...
You can cast the _phasestrike_ force power without expending force points. When you reach 11th level, the damage bonus of the special attack made during _phasestrike_ increases to 2d8, and at 17th level it increases to 3d8.
...
![SL3W6hp](https://www.gmbinder.com/images/SL3W6hp.png)
...
![KJeYR53](https://www.gmbinder.com/images/KJeYR53.png)
...
![5aztMYq](https://www.gmbinder.com/images/5aztMYq.png)
...
![Shaper_of_Kro_Var](https://media.discordapp.net/attachments/469499280994992128/794655203383050253/Shaper_of_Kro_Var.PNG)
...
_**Prerequisite:** River of Hungry Flame_
...
_**Prerequisite:** Shape the Flowing River_
...
_**Prerequisite:** Earth Reaches for Sky_
...
_**Flurry of Blows.**_ When you hit with an attack with Flurry of Blows, you can deal an additional 1d8 damage of the same type.
...
_**Patient Defense.**_ While under the effects of your Patient Defense, when you are hit by an attack, you can use your reaction and roll your Martial Arts die to increase your AC against the attack.

_**Step of the Wind.**_ While under the effects of your Step of the Wind, you can become immune to the shocked condition, and have each slowed level only reduce your speed by 5 feet, unless it would reduce your speed to 0.
...
Additionally, you are constantly under the effects of the _detect enhancement_ tech power. As an action, you can cast the _analyze_ tech power without expending tech points. When you do so, _detect enhancement_ is suppressed and you can't do so again until you complete a short or long rest.

#### Tech Mastery

_**Rakatan Order:** 17th level_
...
![MjQYflG](https://www.gmbinder.com/images/MjQYflG.png)
...
_**Redirect Attack.**_ When a creature misses you with a melee attack roll, you can spend 1 focus point as a reaction to cause that attack to hit one creature of your choice, other than the attacker, that you can see within 5 feet of you.
...
![NOIWq0u](https://www.gmbinder.com/images/NOIWq0u.png)
...
![2yB0wp5](https://www.gmbinder.com/images/2yB0wp5.png)
...
![LPJ9Lon](https://www.gmbinder.com/images/LPJ9Lon.png)
...
_**Disabling Practice:** 17th level_
...
![1R5mZA5](https://www.gmbinder.com/images/1R5mZA5.png)
...
![XjjiVJp](https://www.gmbinder.com/images/XjjiVJp.png)
...
_**Maverick Practice:** 9th level_
...
_**Maverick Practice:** 17th level_
...
![final-twilek](https://i.ibb.co/nnh6s3n/final-twilek.png)
...
_**Pugnacity Practice:** 17th level_
...
![Qcqfpkk](https://www.gmbinder.com/images/Qcqfpkk.png)
...
![XmV9oK4](https://www.gmbinder.com/images/XmV9oK4.png)
...
![sXbGgBh](https://www.gmbinder.com/images/sXbGgBh.png)
...
_**Saboteur Practice:** 17th level_
...
![RVsg9S7](https://www.gmbinder.com/images/RVsg9S7.png)
...
![GHT4jiF](https://www.gmbinder.com/images/GHT4jiF.png)
...
_**Shadow Killer Practice:** 17th level_
...
![WZw4Qw0](https://www.gmbinder.com/images/WZw4Qw0.png)
...
_**Prerequisite:** 9th level_
You can cast the _telekinesis_ force power at 5th level without spending force points.
...
![2qofkgK](https://www.gmbinder.com/images/2qofkgK.png)
...
![WC5CnvQ](https://www.gmbinder.com/images/WC5CnvQ.png)
...
![mBimHwq](https://www.gmbinder.com/images/mBimHwq.png)
...
![6T3NzPT](https://www.gmbinder.com/images/6T3NzPT.png)

#### Chimeric Adaptation

_**Geneticist Pursuit:** 17th level_
...
_**Occultist Pursuit:** 9th level_
...
_**Prerequisite:** 5th level_
You can cast the _bestow curse_ and _remove curse_ force powers without spending force points. Wisdom or Charisma (your choice) is your forcecasting modifier for these powers.
...
You know how to quickly activate anti-tech subroutines you have encoded into your wristpad. You can cast the _diminish tech_ and _tech override_ powers at 3rd level without expending tech points. If the target is the target of your Critical Analysis, you have advantage on the techcasting ability check for these powers.
...
![AlnLVfr](https://www.gmbinder.com/images/AlnLVfr.png)
...
![mckPwzx](https://www.gmbinder.com/images/mckPwzx.png)
...
- Your turret is a valid target of the _tracker droid interface_ tech power.
...
Lastly, while your turret is bonded, within 10 feet of you, and the target of your _tracker droid interface_ tech power, when you cast a tech power with a range of 5 feet or greater, you can cast it as if you were in your turret's space, and the range increases to 10 feet if it isn't greater.
...
![iOUKn16](https://www.gmbinder.com/images/iOUKn16.png)
...
_**Illusionist Technique:** 15th level_
...
![HolographicDisguiseMatrix-SWENoB](https://cdn.discordapp.com/attachments/469499280994992128/533034035631489065/HolographicDisguiseMatrix-SWENoB.png)
...
You can use your action to gain the benefits of the _force sight_ force power until the end of your next turn.
...
_**Inquisitor Technique:** 15th and 17th level_
You can cast the _force suppression_ and _sever force_ force powers at 3rd level against the target of your Ranger's Quarry without expending tech points. If they are within 30 feet of you, you have advantage on the forcecasting ability check for these powers.

You can use this feature five times. You gain an additional use at 17th level. You regain all expended uses when you finish a long rest.

The radius of this feature increases to 60 feet at 17th level.

![6k8LjLG](https://www.gmbinder.com/images/6k8LjLG.png)
...
_**Mastermind Technique:** 15th level_
...
![3Nivnk0](https://www.gmbinder.com/images/3Nivnk0.png)
...
![2DWzzeB](https://www.gmbinder.com/images/2DWzzeB.png)
...
_**Mechanist Technique:** 15th level_
...
![UIwaVgQ](https://www.gmbinder.com/images/UIwaVgQ.png)
...
_**Mechanist Technique:** 7th level_
As a bonus action, you can cause the target of your Ranger's Quarry to emit an ion pulse, as long as the target is within 60 feet of you. The target, and any creatures within 5 feet of it, must make a Constitution saving throw against your tech save DC. On a failed save, roll your Ranger's Quarry die; each creature takes ion damage equal to the amount rolled.
...
![kbZvch9](https://www.gmbinder.com/images/kbZvch9.png)
...
![TidlOHN](https://www.gmbinder.com/images/TidlOHN.png)
...
_**Teleportation Technique:** 15th level_
...
![qpp67Av](https://www.gmbinder.com/images/qpp67Av.png)

![edA6oHo](https://www.gmbinder.com/images/edA6oHo.png)
...
- _**Adrenaline/Tranquilizer.**_ The creature's movement speed is doubled until the end of its next turn. Alternatively, it gains a level of slowed until the end of its next turn.

- _**Focus/Dizziness.**_ The creature has either advantage or disadvantage (your choice) on the first ability check, attack roll, or saving throw it makes within the next minute.

- _**Toughen/Weaken.**_ The creature gains temporary hit points equal to your scout level, which last for 1 minute. Alternatively, the creature must make a Constitution saving throw against your tech save DC. On a failure, it takes psychic damage equal to your scout level and it can't regain hit points until the start of your next turn.
...
![i9YaACg](https://www.gmbinder.com/images/i9YaACg.png)
...
Starting when you choose this calling at 3rd level, you learn the _lightning charge_ force power, which does not count against your total powers known. Additionally, you can use Wisdom or Charisma as your forcecasting ability for it, and when you deal lightning damage with the _lightning charge_ force power, you deal additional lightning damage equal to half your Wisdom or Charisma modifier (your choice, minimum of one) if it doesn't already include that modifier.
...
You've learned to move with speed and precision, discharging your lightning in a massive burst. When you move at least half your speed before casting _lightning charge_, you make the attack roll with advantage. Additionally, on a hit, the lightning can leap a second time, to a third creature within range or back to the first creature.
...
When a creature hits you with an attack while within 5 feet of you, you can use your reaction to cast the _lightning charge_ force power, targeting them.

![DSR5EWH](https://www.gmbinder.com/images/DSR5EWH.png)
...
You learn the _feedback_ force power, which does not count against your total powers known. Additionally, you can use Wisdom or Charisma as your forcecasting ability for it, and you can use the Double Strike Force-Empowered Self option when you cast it as your action and the target fails its saving throw. Finally, when you deal psychic damage with the _feedback_ force power, you deal additional psychic damage equal to your Wisdom or Charisma modifier (your choice, minimum of one) if it doesn't already include that modifier.
...
_**Path of Communion:** 18th level_
...
You learn the _resistance_ force power, which does not count against your total powers known. Additionally, this power no longer requires concentration for you when you target yourself with it.
...
![U2oBpf4](https://www.gmbinder.com/images/U2oBpf4.png)
...
![QeDQQUo](https://www.gmbinder.com/images/QeDQQUo.png)
...
You learn the _guidance_ force power, which does not count against your total powers known. Additionally, this power's die increases by one step (from d4 to d6, d6 to d8, d8 to d10, or d10 to d12).
...
Once per long rest, you can cast the _battle meditation_ force power at its base level without expending force points. While concentrating on _battle meditation_, at the start of each of your turns, the power's die increases by one step (from d4 to d6, d6 to d8, d8 to d10, or d10 to d12).
...
Once per long rest, you can cast the _improved battle meditation_ force power at its base level without expending force points. While concentrating on _improved battle meditation_, at the start of each of your turns, the power's die increases by one step (from d6 to d8, d8 to d10, or d10 to d12).
...
Once per long rest, you can cast the _master battle meditation_ force power without expending force points. While concentrating on _master battle meditation_, at the start of each of your turns, the power's die increases by one step (from d8 to d10, or d10 to d12).
...
![FnJLXn8](https://www.gmbinder.com/images/FnJLXn8.png)
...
![jSndBjr](https://www.gmbinder.com/images/jSndBjr.png)
...
Additionally, if allies within 5 feet of you are gaining the benefit of your _saber ward_ force power, they also gain the benefit of this feature.

#### Kinetic Bastion

_**Path of Tenacity:** 18th level_
...
![uUGZB8C](https://www.gmbinder.com/images/uUGZB8C.png)
...
_**Path of Witchcraft:** 18th level_
...
![lhY2uuG](https://www.gmbinder.com/images/lhY2uuG.png)

![zJp52Jo](https://www.gmbinder.com/images/zJp52Jo.png)
...
![Hk9DXGZ](https://www.gmbinder.com/images/Hk9DXGZ.png)
